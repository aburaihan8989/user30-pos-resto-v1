        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">All Costs</div>
                </div>
            </div>
            <div class="section-body">
                ...
                <p class="section-lead">
                    You can manage all Costs, such as editing, deleting and more.
                </p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="float-right">
                                    <form method="GET" action="{{ route('cost.index') }}">
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table">
                                        ...
                                        @foreach ($costs as $cost)
                                            <tr>
                                                <td>
                                                    {{ $loop->iteration + $costs->firstItem() - 1 }}
                                                </td>
                                                <td>
                                                    {{ $cost->name }}
                                                </td>
